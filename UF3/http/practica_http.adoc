...
fitxer *index.html* a dins que mostri clarament quin lloc estem visitant.
...
*/var/www/test* s'hagi de proporcionar un nom d'usuari i contrasenya vàlids per
poder-hi accedir. Hi haurà dos usuaris amb permís d'accés: *nom* i *cognom*, els
